...
console.log(`${lastName} ${age} ${typeof(age)}`)
...
console.log("Is ageJohn < ageMark ? " + johnOlder);
...
console.log(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
console.log(">>> \tCODING CHALLENGE 1 : BMI withc variables");
console.log(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
...
console.log("scoreJohn, scoreMike, scoreMary", scoreJohn, scoreMike, scoreMary);
...
ref_func = calculateAge


var ageJohn = calculateAge(1990);
var ageMike = calculateAge(1948);
var ageJane = calculateAge(1969);
console.log(ageJohn, ageMike, ageJane, ref_func(200)); // add
...
console.log("DAJEEEEE", typeof calculateAge, calculateAge)
...
function whatDoYouDo_(job, firstName) {
...
// DELETE
john.pop(); // Removes the last element from an array and returns it.
john.pop();
...
console.log(`tips ${tips} and finalValues ${finalValues}`);
...
console.log(john.firstName);    // dot notaion
console.log(john['lastName']);  // with brackets 
var x = 'birthYear';
console.log(john[x]);
...
var john = {
    ...
    otherMethod: function(aaa) { // heheheheh
        return "Dajeee"
    }
};
...
//  !!!! NOTE !!!!!
for (x in myString) {
    console.log(x, myString[x]) // this print index !!
}
