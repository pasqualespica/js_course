...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Search; });\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n// export default \"I'm an exported string DAEJEEEE\";\n\nclass Search {\n  constructor(query) {\n    this.query = query;\n  }\n\n  async geResults() {\n    try {\n      // see Forkify API v1 documentation\n      // http://forkify-api.herokuapp.com/\n      const url = \"https://forkify-api.herokuapp.com/api/search\"; // axios like a FETCH - Promise but result is just a JSON\n\n      const ressponse = await axios__WEBPACK_IMPORTED_MODULE_0___default()(`${url}?q=${this.query}`); // console.log(`I have read >> ${ressponse.data.count} << RECEPIEs`);\n      // console.log(\">>>>>>>>>> RESPONSE >>>>>>>>>>>>>>>>>>>>\");\n      // console.log(ressponse);\n      // console.log(\">>>>>>>>>> RESPONSE >>>>>>>>>>>>>>>>>>>>\");\n\n      this.result = ressponse.data.recipes; // console.log(\":::::::::: recipes :::::::::::::::::::::\");\n      // console.log(this.result);\n      // console.log(\":::::::::: recipes :::::::::::::::::::::\");\n    } catch (error) {\n      alert(error);\n    }\n  }\n\n}\n\n//# sourceURL=webpack:///./src/js/modules/Search.js?");
